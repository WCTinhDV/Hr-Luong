...
namespace Plugin_LuongNhanvien
{
    public class Plugin_LuongNhanvien : IPlugin
    {
        ...
        private void ProcessUpdateOrCreate(IPluginExecutionContext context, IOrganizationService service)
        {
            ...
            {
                if (target.LogicalName != "cr44a_luongnhanvien")
                {
                    traceService.Trace("Bỏ qua plugin vì không phải thực thể crdfd_bangluong.");
                    return;
                }
            ...
            new { Field = "cr44a_luonghieusuat", EncryptedField = "cr44a_luonghieusuatmahoa", IvField = "cr44a_idvluonghieusuat" }
            };
    ...
    .ToList();
                ...
                try
                {
                    ...
                    target["cr44a_checkplugin"] = true; // Gán giá trị tạm thời
        ...
        private void ProcessRetrieve(IPluginExecutionContext context, IOrganizationService service)
        {
            ...
            new { EncryptedField = "cr44a_luonghieusuatmahoa", IvField = "cr44a_idvluonghieusuat", ResultField = "cr44a_luonghieusuat" }
        };
