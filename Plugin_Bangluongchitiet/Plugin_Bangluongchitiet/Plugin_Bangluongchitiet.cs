...
namespace Plugin_Bangluongchitiet
{
    public class Plugin_Bangluongchitiet : IPlugin
    {
        ...
        private void ProcessUpdateOrCreate(IPluginExecutionContext context, IOrganizationService service)
        {
            ...
            {
                if (target.LogicalName != "crdfd_bangluongchitiet")
                {
                    traceService.Trace("Bỏ qua plugin vì không phải thực thể crdfd_bangluongchitiet.");
                    return;
                }
            ...
            new { Field = "crdfd_luongthoathuanthangnay", EncryptedField = "crdfd_mahoaluongthoathuanthangnay", IvField = "crdfd_idvluongthoathuanthangnay" },
            new { Field = "crdfd_luonghieusuat", EncryptedField = "crdfd_mahoaluonghieusuat", IvField = "crdfd_idvluonghieusuat" },
            new { Field = "crdfd_luonghieusuatthucte", EncryptedField = "crdfd_mahoaluonghieusuatthucte", IvField = "crdfd_idvluonghieusuatthucte" },
            new { Field = "crdfd_tongtienotkhongchiuthue", EncryptedField = "crdfd_mahoatongtienotkhongchiuthue", IvField = "crdfd_idvtongtienotkhongchiuthue" },
            new { Field = "crdfd_tongtienotchiuthue", EncryptedField = "crdfd_mahoatongtienotchiuthue", IvField = "crdfd_idvtongtienotchiuthue" },
            new { Field = "crdfd_tongtienngoaigio", EncryptedField = "crdfd_mahoatongtienngoaigio", IvField = "crdfd_idvtongtienngoaigio" },
            new { Field = "crdfd_tongthunhap", EncryptedField = "crdfd_mahoatongthunhap", IvField = "crdfd_idvtongthunhap" },
            new { Field = "crdfd_thunhaptinhthue", EncryptedField = "crdfd_mahoathunhaptinhthue", IvField = "crdfd_idvthunhaptinhthue" },
            new { Field = "crdfd_pitluytien", EncryptedField = "crdfd_mahoapitluytien", IvField = "crdfd_idvpitluytien" },
            new { Field = "crdfd_pit10", EncryptedField = "crdfd_mahoapit10", IvField = "crdfd_idvpit10" },
            new { Field = "crdfd_goppit", EncryptedField = "crdfd_mahoagoppit", IvField = "crdfd_idvgoppit" },
            new { Field = "crdfd_luongthucnhan", EncryptedField = "crdfd_mahoaluongthucnhan", IvField = "crdfd_idvluongthucnhan" },
            new { Field = "crdfd_tongchiphiluong", EncryptedField = "crdfd_mahoatongchiphiluong", IvField = "crdfd_idvtongchiphiluong" }
            };
    ...
    .ToList();
        ...
        private void ProcessRetrieve(IPluginExecutionContext context, IOrganizationService service)
        {
            ...
            new { ResultField = "crdfd_luongthoathuanthangnay", EncryptedField = "crdfd_mahoaluongthoathuanthangnay", IvField = "crdfd_idvluongthoathuanthangnay" },
            new { ResultField = "crdfd_luonghieusuat", EncryptedField = "crdfd_mahoaluonghieusuat", IvField = "crdfd_idvluonghieusuat" },
            new { ResultField = "crdfd_luonghieusuatthucte", EncryptedField = "crdfd_mahoaluonghieusuatthucte", IvField = "crdfd_idvluonghieusuatthucte" },
            new { ResultField = "crdfd_tongtienotkhongchiuthue", EncryptedField = "crdfd_mahoatongtienotkhongchiuthue", IvField = "crdfd_idvtongtienotkhongchiuthue" },
            new { ResultField = "crdfd_tongtienotchiuthue", EncryptedField = "crdfd_mahoatongtienotchiuthue", IvField = "crdfd_idvtongtienotchiuthue" },
            new { ResultField = "crdfd_tongtienngoaigio", EncryptedField = "crdfd_mahoatongtienngoaigio", IvField = "crdfd_idvtongtienngoaigio" },
            new { ResultField = "crdfd_tongthunhap", EncryptedField = "crdfd_mahoatongthunhap", IvField = "crdfd_idvtongthunhap" },
            new { ResultField = "crdfd_thunhaptinhthue", EncryptedField = "crdfd_mahoathunhaptinhthue", IvField = "crdfd_idvthunhaptinhthue" },
            new { ResultField = "crdfd_pitluytien", EncryptedField = "crdfd_mahoapitluytien", IvField = "crdfd_idvpitluytien" },
            new { ResultField = "crdfd_pit10", EncryptedField = "crdfd_mahoapit10", IvField = "crdfd_idvpit10" },
            new { ResultField = "crdfd_goppit", EncryptedField = "crdfd_mahoagoppit", IvField = "crdfd_idvgoppit" },
            new { ResultField = "crdfd_luongthucnhan", EncryptedField = "crdfd_mahoaluongthucnhan", IvField = "crdfd_idvluongthucnhan" },
            new { ResultField = "crdfd_tongchiphiluong", EncryptedField = "crdfd_mahoatongchiphiluong", IvField = "crdfd_idvtongchiphiluong" }
        };
